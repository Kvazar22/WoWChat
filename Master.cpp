...
#include "SocketConnectorRunnable.h" //WowChat
...
int Master::Run()
{
    ...
    ACE_Based::Thread socket_connector_thread(new SocketConnectorRunnable); //WowChat
    ...
    world_thread.wait();
    rar_thread.wait();
	socket_connector_thread.wait(); //WowChat
